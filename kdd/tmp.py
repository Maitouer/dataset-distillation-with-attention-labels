...
TASK_ATTRS = {
    # Amazon-beauty
    "beauty": {
        "load_args": ("McAuley-Lab/Amazon-Reviews-2023", "0core_timestamp_All_Beauty"),
...
@dataclass
class DataConfig:
    task_name: str = "beauty"
    datasets_path: Path = "../data/beauty/datasets/"
    preprocessed_datasets_path: Path = "../data/beauty/datasets_for_dd/"
    ...
    def get_dataset(self):
        ...
        if os.path.exists(self.config.datasets_path):
            ...
            datasets = load_dataset(
                *self.dataset_attr["load_args"], trust_remote_code=True
            )
